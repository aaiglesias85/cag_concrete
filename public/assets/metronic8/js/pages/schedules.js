var Schedules = (function () {
   ...
   var listarCalendario = function () {
      ...
      axios
         .post('schedule/listarParaCalendario', formData, { responseType: 'json' })
         .then(function (res) {
   ...
   var exportButtons = () => {
      ...
      var buttons = new $.fn.dataTable.Buttons(table, {
         ...
         .container()
         .appendTo($('#schedule-table-editable-buttons'));
   ...
   var SalvarSchedule = function () {
      ...
      if (validateForm() && project_id !== '' && isValidFechas()) {
         ...
         axios
            .post('schedule/salvar', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
   ...
   var ActualizarSchedule = function () {
      ...
      if (validateForm() && project_id !== '' && isValidFechas()) {
         ...
         axios
            .post('schedule/actualizar', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
   ...
   var initAccionChange = function () {
      ...
      $(document).on('click', '#btn-exit-save-and-close', function (e) {
         ...
         $('#btn-salvar-schedule').trigger('click');
      });
   ...
   function editRow(schedule_id) {
      ...
      axios
         .post('schedule/cargarDatos', formData, { responseType: 'json' })
         .then(function (res) {
            if (res.status === 200 || res.status === 201) {
               var response = res.data;
               if (response.success) {
   ...
   var initAccionEliminar = function () {
      ...
      function btnClickModalEliminar() {
         ...
         axios
            .post('schedule/eliminar', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
      ...
      function btnClickModalEliminarSeleccion() {
         ...
         axios
            .post('schedule/eliminarSchedules', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
   ...
   var listarContactsDeProject = function (project_id) {
      ...
      axios
         .post('project/listarContacts', formData, { responseType: 'json' })
         .then(function (res) {
            if (res.status === 200 || res.status === 201) {
               var response = res.data;
               if (response.success) {
   ...
   var listarContactsDeConcreteVendor = function (vendor_id) {
      ...
      axios
         .post('concrete-vendor/listarContacts', formData, { responseType: 'json' })
         .then(function (res) {
            if (res.status === 200 || res.status === 201) {
               var response = res.data;
               if (response.success) {
   ...
   var initAccionClonar = function () {
      ...
      $(document).on('click', '#btn-clonar-schedule', function (e) {
         ...
         if (validateFormClonar() && schedules_id !== '' && date_start !== '' && date_stop !== '') {
            ...
            axios
               .post('schedule/clonar', formData, { responseType: 'json' })
               .then(function (res) {
                  if (res.status === 200 || res.status === 201) {
                     var response = res.data;
                     if (response.success) {
   ...
   var initAccionExportar = function () {
      ...
      $(document).on('click', '#btn-exportar', function (e) {
         ...
         axios
            .post('schedule/exportarExcel', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {

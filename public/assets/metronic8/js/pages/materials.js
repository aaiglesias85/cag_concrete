var Materials = (function () {
   ...
   var initTable = function () {
      ...
      // datasource
      const datasource =
         DatatableUtil.getDataTableDatasource(`material/listar`);
   ...
   var handleSearchDatatable = function () {
      const filterSearch = document.querySelector(
         '#lista-material [data-table-filter="search"]',
      );
      let debounceTimeout;
   ...
   var exportButtons = () => {
      ...
      var buttons = new $.fn.dataTable.Buttons(table, {
         ...
         .container()
         .appendTo($("#material-table-editable-buttons"));

      // Hook dropdown menu click event to datatable export buttons
      const exportButtons = document.querySelectorAll(
         "#material_export_menu [data-kt-export]",
      );
   ...
   var initAccionNuevo = function () {
      ...
      function btnClickNuevo() {
         ...
         KTUtil.find(KTUtil.get("form-material"), ".card-label").innerHTML =
            "New Material:";
   ...
   var initAccionChange = function () {
      ...
      $(document).on("click", "#btn-exit-save-and-close", function (e) {
         ...
         $("#btn-salvar-material").trigger("click");
      });
   ...
   var initAccionEditar = function () {
      ...
      function editRow(material_id) {
         ...
         axios
            .post("material/cargarDatos", formData, { responseType: "json" })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
         ...
         function cargarDatos(material) {
            ...
            NumberUtil.setFormattedValue("#price", material.price, {
               decimals: 2,
            });
   ...
   var initAccionEliminar = function () {
      ...
      $(document).on(
         "click",
         "#material-table-editable a.delete",
         function (e) {
            e.preventDefault();
      ...
      function btnClickModalEliminar() {
         ...
         axios
            .post("material/eliminarMaterial", formData, {
               responseType: "json",
            })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
      ...
      function btnClickModalEliminarSeleccion() {
         ...
         axios
            .post("material/eliminarMaterials", formData, {
               responseType: "json",
            })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
   ...
   var initAccionesUnit = function () {
      ...
      $("#modal-unit").on("hidden.bs.modal", function () {
         ...
         if (unit != null) {
            $("#unit").append(
               new Option(unit.description, unit.unit_id, false, false),
            );
            $("#unit").select2();

var PlanStatus = (function () {
   ...
   var initTable = function () {
      ...
      // datasource
      const datasource =
         DatatableUtil.getDataTableDatasource(`plan-status/listar`);
   ...
   var handleSearchDatatable = function () {
      const filterSearch = document.querySelector(
         '#lista-plan-status [data-table-filter="search"]',
      );
      let debounceTimeout;
   ...
   var exportButtons = () => {
      ...
      var buttons = new $.fn.dataTable.Buttons(table, {
         ...
         .container()
         .appendTo($("#plan-status-table-editable-buttons"));

      // Hook dropdown menu click event to datatable export buttons
      const exportButtons = document.querySelectorAll(
         "#plan-status_export_menu [data-kt-export]",
      );
   ...
   var initAccionNuevo = function () {
      ...
      function btnClickNuevo() {
         ...
         KTUtil.find(KTUtil.get("form-plan-status"), ".card-label").innerHTML =
            "New Plan Status:";
   ...
   var initAccionSalvar = function () {
      ...
      function btnClickSalvarForm() {
         ...
         if (validateForm()) {
            ...
            var salvarUrl =
               status_id && String(status_id).trim() !== ""
                  ? "plan-status/actualizar"
                  : "plan-status/salvar";
   ...
   var initAccionEditar = function () {
      ...
      $(document).on(
         "click",
         "#plan-status-table-editable a.edit",
         function (e) {
            e.preventDefault();
            resetForms();
      ...
      function editRow(status_id) {
         ...
         axios
            .post("plan-status/cargarDatos", formData, { responseType: "json" })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
         ...
         function cargarDatos(status) {
            KTUtil.find(
               KTUtil.get("form-plan-status"),
               ".card-label",
            ).innerHTML = "Update Plan Status: " + status.description;
   ...
   var initAccionEliminar = function () {
      ...
      $(document).on(
         "click",
         "#plan-status-table-editable a.delete",
         function (e) {
            e.preventDefault();
      ...
      function btnClickModalEliminar() {
         ...
         axios
            .post("plan-status/eliminar", formData, { responseType: "json" })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
      ...
      function btnClickModalEliminarSeleccion() {
         ...
         axios
            .post("plan-status/eliminarStatus", formData, {
               responseType: "json",
            })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {

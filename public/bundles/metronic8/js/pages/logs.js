var Logs = (function () {
   ...
   var getColumnsTable = function () {
      ...
      columns.push({ data: 'fecha' }, { data: 'usuario' }, { data: 'operacion' }, { data: 'categoria' }, { data: 'descripcion' }, { data: 'ip' }, { data: null });
   ...
   var exportButtons = () => {
      ...
      var buttons = new $.fn.dataTable.Buttons(table, {
         ...
         .container()
         .appendTo($('#log-table-editable-buttons'));
   ...
   var initAccionEliminar = function () {
      ...
      function btnClickModalEliminar() {
         ...
         axios
            .post('log/eliminarLog', formData, { responseType: 'json' })
            .then(function (res) {
      ...
      function btnClickModalEliminarSeleccion() {
         ...
         axios
            .post('log/eliminarLogs', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {

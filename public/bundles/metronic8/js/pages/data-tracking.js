var DataTracking = (function () {
   ...
   var exportButtons = () => {
      ...
      var buttons = new $.fn.dataTable.Buttons(table, {
         ...
         .container()
         .appendTo($('#data-tracking-table-editable-buttons'));
   ...
   var initAccionEliminar = function () {
      ...
      function btnClickModalEliminar() {
         ...
         axios
            .post('data-tracking/eliminarDataTracking', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
      ...
      function btnClickModalEliminarSeleccion() {
         ...
         axios
            .post('data-tracking/eliminarDataTrackings', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
   ...
   var changeFile = function () {
      ...
      if (!allowed.includes(ext)) {
         ...
         $error.removeClass('d-none').text('Invalid file type. Allowed: ' + allowed.join(', ') + '.');
   ...
   var listarItemsDeProject = function (project_id) {
      ...
      axios
         .post('project/listarItems', formData, { responseType: 'json' })
         .then(function (res) {
            if (res.status === 200 || res.status === 201) {
               var response = res.data;
               if (response.success) {
   ...
   var initTableItems = function () {
      ...
      let columnDefs = [
         {
            ...
            render: function (data, type, row) {
               ...
               var icono = '';
               if (row.change_order && !row.isGroupHeader && row.item_id) {
      ...
      oTableItems = DatatableUtil.initSafeDataTable(table, {
         ...
         columnDefs: columnDefs,
         language: language,
         // marcar change order y encabezados de grupo
         createdRow: (row, data, index) => {
      ...
      function EliminarItem(posicion) {
         if (items_data_tracking[posicion]) {
            if (items_data_tracking[posicion].data_tracking_item_id != '') {
               ...
               axios
                  .post('data-tracking/eliminarItem', formData, { responseType: 'json' })
                  .then(function (res) {
                     if (res.status === 200 || res.status === 201) {
                        var response = res.data;
                        if (response.success) {
   ...
   var initTableLabor = function () {
      ...
      // columns
      const columns = [{ data: 'employee' }, { data: 'subcontractor' }, { data: 'role' }, { data: 'hours' }, { data: 'total' }, { data: null }];
   ...
   var initAccionesLabor = function () {
      ...
      function EliminarLabor(posicion) {
         if (labor[posicion]) {
            if (labor[posicion].data_tracking_labor_id != '') {
               ...
               axios
                  .post('data-tracking/eliminarLabor', formData, { responseType: 'json' })
                  .then(function (res) {
                     if (res.status === 200 || res.status === 201) {
                        var response = res.data;
                        if (response.success) {
      ...
      function changeSubcontractor() {
         ...
         if (subcontractor_id != '') {
            ...
            axios
               .post('subcontractor/listarEmployeesDeSubcontractor', formData, { responseType: 'json' })
               .then(function (res) {
                  if (res.status === 200 || res.status === 201) {
                     var response = res.data;
                     if (response.success) {
   ...
   var initTableMaterial = function () {
      ...
      // columns
      const columns = [{ data: 'material' }, { data: 'unit' }, { data: 'quantity' }, { data: 'price' }, { data: 'total' }, { data: null }];
      ...
      function EliminarMaterial(posicion) {
         if (materials[posicion]) {
            if (materials[posicion].data_tracking_material_id != '') {
               ...
               axios
                  .post('data-tracking/eliminarMaterial', formData, { responseType: 'json' })
                  .then(function (res) {
                     if (res.status === 200 || res.status === 201) {
                        var response = res.data;
                        if (response.success) {
   ...
   var initTableConcVendor = function () {
      ...
      // columns
      const columns = [{ data: 'vendor' }, { data: 'total_conc_used' }, { data: 'conc_price' }, { data: 'total' }, { data: null }];
      ...
      function EliminarConcVendor(posicion) {
         if (conc_vendors[posicion]) {
            if (conc_vendors[posicion].data_tracking_conc_vendor_id != '') {
               ...
               axios
                  .post('data-tracking/eliminarConcVendor', formData, { responseType: 'json' })
                  .then(function (res) {
                     if (res.status === 200 || res.status === 201) {
                        var response = res.data;
                        if (response.success) {
      ...
      function EliminarSubcontractor(posicion) {
         if (subcontracts[posicion]) {
            if (subcontracts[posicion].subcontract_id != '') {
               ...
               axios
                  .post('data-tracking/eliminarSubcontract', formData, { responseType: 'json' })
                  .then(function (res) {
                     if (res.status === 200 || res.status === 201) {
                        var response = res.data;
                        if (response.success) {
   ...
   var initAccionesArchivo = function () {
      ...
      function eliminarArchivo(posicion) {
         if (archivos[posicion]) {
            ...
            axios
               .post('data-tracking/eliminarArchivo', formData, { responseType: 'json' })
               .then(function (res) {
                  if (res.status === 200 || res.status === 201) {
                     var response = res.data;
                     if (response.success) {
      ...
      $(document).on('click', '#btn-eliminar-archivos', function (e) {
         ...
         function EliminarArchivos(ids, archivos_name) {
            ...
            axios
               .post('data-tracking/eliminarArchivos', formData, { responseType: 'json' })
               .then(function (res) {
                  if (res.status === 200 || res.status === 201) {
                     var response = res.data;
                     if (response.success) {

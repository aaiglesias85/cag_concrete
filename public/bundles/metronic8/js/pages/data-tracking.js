var DataTracking = function () {
    ...
    var initAccionSalvar = function () {
        ...
        function btnClickSalvarForm() {
            ...
            if ($('#data-tracking-form').valid() && (data_tracking_id != '' || (data_tracking_id == '' && project_id != ''))) {
                ...
                BlockUtil.block('#modal-data-tracking .modal-content');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        BlockUtil.unblock('#modal-data-tracking .modal-content');
                        if (response.success) {
    ...
    var initAccionFiltrarProjects = function () {
        ...
        function btnClickFiltrarProjects() {
            ...
            BlockUtil.block('#modal-filter-project .modal-content');
            ...
            $.ajax({
                ...
                success: function (response) {
                    BlockUtil.unblock('#modal-filter-project .modal-content');
                    if (response.success) {
    ...
    var initTableLabor = function () {
        BlockUtil.block('#labor-table-editable');
        ...
        oTableItems
            .on('m-datatable--on-ajax-done', function () {
                BlockUtil.unblock('#labor-table-editable');
            })
            .on('m-datatable--on-ajax-fail', function (e, jqXHR) {
                BlockUtil.unblock('#labor-table-editable');
            })
    ...
    var initTableConcVendor = function () {
        BlockUtil.block('#conc-vendor-table-editable');
        ...
        oTableItems
            .on('m-datatable--on-ajax-done', function () {
                BlockUtil.unblock('#conc-vendor-table-editable');
            })
            .on('m-datatable--on-ajax-fail', function (e, jqXHR) {
                BlockUtil.unblock('#conc-vendor-table-editable');
            })
    ...
    var initTableSubcontracts = function () {
        BlockUtil.block('#subcontracts-table-editable');
        ...
        oTableSubcontracts
            .on('m-datatable--on-ajax-done', function () {
                BlockUtil.unblock('#subcontracts-table-editable');
            })
            .on('m-datatable--on-ajax-fail', function (e, jqXHR) {
                BlockUtil.unblock('#subcontracts-table-editable');
            })

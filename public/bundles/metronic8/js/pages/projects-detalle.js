var ProjectsDetalle = (function () {
   ...
   var handleUnpaidQtyHistoryCompletion = function () {
      $(document).off('click', '#lista-items-completion-detalle .unpaid-qty-history-icon-completion');
      $(document).on('click', '#lista-items-completion-detalle .unpaid-qty-history-icon-completion', function (e) {
         e.preventDefault();
         e.stopPropagation();
         var project_item_id = $(this).data('project-item-id');
         if (project_item_id) {
   ...
   var handlePaidQtyOverrideHistoryCompletion = function () {
      $(document).off('click', '#lista-items-completion-detalle .paid-qty-override-history-icon-completion');
      $(document).on('click', '#lista-items-completion-detalle .paid-qty-override-history-icon-completion', function (e) {
         e.preventDefault();
         e.stopPropagation();
         var project_item_id = $(this).data('project-item-id');
         if (project_item_id) {

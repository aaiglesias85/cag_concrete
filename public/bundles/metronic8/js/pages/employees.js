      ...
      let columnDefs = [
         ...
         },
         {
            ...
            render: function (data, type, row) {
               ...
               return DatatableUtil.getRenderColumnDiv(html, 200);
            },
         },
         {
            targets: 3,
         ...
         },
         {
            targets: 7,
            render: function (data, type, row) {
               return DatatableUtil.getRenderColumnDiv(MyApp.formatMoney(data), 100);
            },
         },
         {
            targets: 9,
   ...
   var initAccionSalvar = function () {
      ...
      function btnClickSalvarForm() {
         ...
         if (validateForm()) {
            ...
            var hourly_rate = NumberUtil.getNumericValue('#hourly_rate');
   ...
   var initAccionEditar = function () {
      ...
      function editRow(employee_id) {
         ...
         function cargarDatos(employee) {
            ...
            NumberUtil.setFormattedValue('#hourly_ rate', employee.hourly_rate, { decimals: 2 });

var Companies = (function () {
   ...
   var getColumnsTable = function () {
      ...
      columns.push({ data: 'name' }, { data: 'phone' }, { data: 'address' }, { data: null });
   ...
   var exportButtons = () => {
      ...
      var buttons = new $.fn.dataTable.Buttons(table, {
         ...
         .container()
         .appendTo($('#company-table-editable-buttons'));
   ...
   var initAccionEliminar = function () {
      ...
      function btnClickModalEliminar() {
         ...
         axios
            .post('company/eliminarCompany', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
      ...
      function btnClickModalEliminarSeleccion() {
         ...
         axios
            .post('company/eliminarCompanies', formData, { responseType: 'json' })
            .then(function (res) {
               if (res.status === 200 || res.status === 201) {
                  var response = res.data;
                  if (response.success) {
   ...
   var initTableListaProjects = function () {
      ...
      // columns
      const columns = [{ data: 'projectNumber' }, { data: 'county' }, { data: 'name' }, { data: 'description' }, { data: 'dueDate' }, { data: 'status' }, { data: 'nota' }, { data: null }];

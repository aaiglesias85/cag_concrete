var PlanDownloading = function () {
    ...
    var initTable = function () {
        MyApp.block('#plan-downloading-table-editable');
        ...
        oTable
            .on('m-datatable--on-ajax-done', function () {
                mApp.unblock('#plan-downloading-table-editable');
            })
    ...
    var initAccionSalvar = function () {
        ...
        function btnClickSalvarForm() {
            ...
            if ($('#plan-downloading-form').valid()) {
                ...
                MyApp.block('#form-plan-downloading');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        mApp.unblock('#form-plan-downloading');
                        if (response.success) {

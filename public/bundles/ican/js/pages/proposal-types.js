var ProposalTypes = function () {
    ...
    var initTable = function () {
        MyApp.block('#proposal-type-table-editable');
        ...
        oTable
            .on('m-datatable--on-ajax-done', function () {
                mApp.unblock('#proposal-type-table-editable');
            })
    ...
    var initAccionSalvar = function () {
        ...
        function btnClickSalvarForm() {
            ...
            if ($('#proposal-type-form').valid()) {
                ...
                MyApp.block('#form-proposal-type');
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        mApp.unblock('#form-proposal-type');
                        if (response.success) {
    ...
    var initAccionEditar = function () {
        ...
        $(document).on('click', "#proposal-type-table-editable a.edit", function (e) {
            e.preventDefault();
            resetForms();
    ...
    var initAccionEliminar = function () {
        ...
        $(document).on('click', "#proposal-type-table-editable a.delete", function (e) {
            e.preventDefault();

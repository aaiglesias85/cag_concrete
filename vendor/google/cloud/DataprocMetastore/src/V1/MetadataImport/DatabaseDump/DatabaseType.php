...
namespace Google\Cloud\Metastore\V1\MetadataImport\DatabaseDump;
 ...
 *
 * Protobuf type <code>google.cloud.metastore.v1.MetadataImport.DatabaseDump.DatabaseType</code>
 */
class DatabaseType
{
    /**

...
namespace Google\Cloud\Metastore\V1alpha\MetadataImport\DatabaseDump;
 ...
 *
 * Protobuf type <code>google.cloud.metastore.v1alpha.MetadataImport.DatabaseDump.DatabaseType</code>
 */
class DatabaseType
{
    /**

 ...
 *
 * Generated from protobuf message <code>grafeas.v1.SlsaProvenance.SlsaMetadata</code>
 */
class SlsaMetadata extends \Google\Protobuf\Internal\Message
{
     ...
     *           The timestamp of when the build completed.
     *     @type \Grafeas\V1\SlsaProvenance\SlsaCompleteness $completeness
     *           Indicates that the builder claims certain fields in this message to be
     *           complete.
     ...
     *
     * Generated from protobuf field <code>.grafeas.v1.SlsaProvenance.SlsaCompleteness completeness = 4;</code>
     * @return \Grafeas\V1\SlsaProvenance\SlsaCompleteness|null
     */
     ...
     *
     * Generated from protobuf field <code>.grafeas.v1.SlsaProvenance.SlsaCompleteness completeness = 4;</code>
     * @param \Grafeas\V1\SlsaProvenance\SlsaCompleteness $var
     * @return $this
     */
    public function setCompleteness($var)
    {
        GPBUtil::checkMessage($var, \Grafeas\V1\SlsaProvenance\SlsaCompleteness::class);

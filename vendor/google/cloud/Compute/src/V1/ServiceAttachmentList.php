...
/**
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.ServiceAttachmentList</code>
 */
class ServiceAttachmentList extends \Google\Protobuf\Internal\Message
{
    /**
     ...
     *     @type string $id
     *           [Output Only] Unique identifier for the resource; defined by the server.
     *     @type \Google\Cloud\Compute\V1\ServiceAttachment[]|\Google\Protobuf\Internal\RepeatedField $items
     *           A list of ServiceAttachment resources.
     *     @type string $kind
     *           [Output Only] Type of the resource. Always compute#serviceAttachment for service attachments.

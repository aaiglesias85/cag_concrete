 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.SetIamPolicyMachineImageRequest</code>
 */
class SetIamPolicyMachineImageRequest extends \Google\Protobuf\Internal\Message
{
    /**

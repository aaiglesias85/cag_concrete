 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.PatchRuleFirewallPolicyRequest</code>
 */
class PatchRuleFirewallPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**

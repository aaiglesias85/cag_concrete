...
namespace Google\Cloud\Compute\V1\ServiceAttachmentConnectedEndpoint;
 ...
 *
 * Protobuf type <code>google.cloud.compute.v1.ServiceAttachmentConnectedEndpoint.Status</code>
 */
class Status
{
    /**

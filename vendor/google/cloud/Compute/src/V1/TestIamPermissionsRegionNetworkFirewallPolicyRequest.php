 ...
 *
 * Generated from protobuf message <code>google.cloud.compute.v1.TestIamPermissionsRegionNetworkFirewallPolicyRequest</code>
 */
class TestIamPermissionsRegionNetworkFirewallPolicyRequest extends \Google\Protobuf\Internal\Message
{
    /**

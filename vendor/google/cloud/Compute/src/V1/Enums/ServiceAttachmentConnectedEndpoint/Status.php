...
namespace Google\Cloud\Compute\V1\Enums\ServiceAttachmentConnectedEndpoint;

/**
 * Status contains string constants that represent the names of each value in the
 * google.cloud.compute.v1.ServiceAttachmentConnectedEndpoint.Status descriptor.
 */
class Status
{

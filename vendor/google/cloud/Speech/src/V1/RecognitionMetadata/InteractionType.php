 ...
 * by.
 *
 * Protobuf type <code>google.cloud.speech.v1.RecognitionMetadata.InteractionType</code>
 */
...
class_alias(InteractionType::class, \Google\Cloud\Speech\V1\RecognitionMetadata_InteractionType::class);

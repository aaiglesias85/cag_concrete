 ...
 *
 * Protobuf type <code>google.cloud.speech.v1.RecognitionMetadata.MicrophoneDistance</code>
 */
...
class_alias(MicrophoneDistance::class, \Google\Cloud\Speech\V1\RecognitionMetadata_MicrophoneDistance::class);

 ...
 *
 * Generated from protobuf message <code>google.cloud.speech.v1.CustomClass</code>
 */
class CustomClass extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Speech\V1\CustomClass\ClassItem::class);
        $this->items = $arr;

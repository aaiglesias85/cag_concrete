...
class TextExtractionEvaluationMetrics extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type float $au_prc
     *           Output only. The Area under precision recall curve metric.
     *     @type \Google\Cloud\AutoMl\V1beta1\TextExtractionEvaluationMetrics\ConfidenceMetricsEntry[]|\Google\Protobuf\Internal\RepeatedField $confidence_metrics_entries
     *           Output only. Metrics that have confidence thresholds.
     *           Precision-recall curve can be derived from it.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.automl.v1beta1.TextExtractionEvaluationMetrics.ConfidenceMetricsEntry confidence_metrics_entries = 2;</code>
     * @param \Google\Cloud\AutoMl\V1beta1\TextExtractionEvaluationMetrics\ConfidenceMetricsEntry[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */

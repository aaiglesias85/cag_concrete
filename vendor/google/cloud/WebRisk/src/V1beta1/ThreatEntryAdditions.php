 ...
 *
 * Generated from protobuf message <code>google.cloud.webrisk.v1beta1.ThreatEntryAdditions</code>
 */
class ThreatEntryAdditions extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.webrisk.v1beta1.RawHashes raw_hashes = 1;</code>
     */
    private $raw_hashes;
    /**
     ...
     *
     *     @type \Google\Cloud\WebRisk\V1beta1\RawHashes[]|\Google\Protobuf\Internal\RepeatedField $raw_hashes
     *           The raw SHA256-formatted entries.
     *           Repeated to allow returning sets of hashes with different prefix sizes.
     *     @type \Google\Cloud\WebRisk\V1beta1\RiceDeltaEncoding $rice_hashes
     *           The encoded 4-byte prefixes of SHA256-formatted entries, using a
     *           Golomb-Rice encoding. The hashes are converted to uint32, sorted in
     *           ascending order, then delta encoded and stored as encoded_data.
     * }
     ...
     *
     * Generated from protobuf field <code>repeated .google.cloud.webrisk.v1beta1.RawHashes raw_hashes = 1;</code>
     * @param \Google\Cloud\WebRisk\V1beta1\RawHashes[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */

...
use Google\Cloud\Redis\V1beta1\ExportInstanceRequest;
use Google\Cloud\Redis\V1beta1\FailoverInstanceRequest;
use Google\Cloud\Redis\V1beta1\GetInstanceAuthStringRequest;
use Google\Cloud\Redis\V1beta1\GetInstanceRequest;
use Google\Cloud\Redis\V1beta1\ImportInstanceRequest;
...
use Google\Cloud\Redis\V1beta1\RescheduleMaintenanceRequest;
...
class CloudRedisGapicClient
{
     ...
     *                               For allowed values, use constants defined on {@see \Google\Cloud\Redis\V1beta1\RescheduleMaintenanceRequest\RescheduleType}
     * @param array  $optionalArgs   {
     *     Optional.
     *

 ...
 * The output content
 *
 * Generated from protobuf message <code>google.cloud.redis.v1beta1.OutputConfig</code>
 */
class OutputConfig extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \Google\Cloud\Redis\V1beta1\GcsDestination $gcs_destination
     ...
     *
     * Generated from protobuf field <code>.google.cloud.redis.v1beta1.GcsDestination gcs_destination = 1;</code>
     * @param \Google\Cloud\Redis\V1beta1\GcsDestination $var
     * @return $this
     */
    public function setGcsDestination($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Redis\V1beta1\GcsDestination::class);

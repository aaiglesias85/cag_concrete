...
return [
    'interfaces' => [
        'google.cloud.aiplatform.v1.FeaturestoreOnlineServingService' => [
            'ReadFeatureValues' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:readFeatureValues',
                'body' => '*',
                'placeholders' => [
                    'entity_type' => [
                        'getters' => [
            ...
            'StreamingReadFeatureValues' => [
                'method' => 'post',
                'uriTemplate' => '/v1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:streamingReadFeatureValues',
                'body' => '*',
                'placeholders' => [
                    'entity_type' => [
                        'getters' => [

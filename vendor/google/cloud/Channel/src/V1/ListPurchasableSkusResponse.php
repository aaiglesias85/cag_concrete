 ...
 *
 * Generated from protobuf message <code>google.cloud.channel.v1.ListPurchasableSkusResponse</code>
 */
class ListPurchasableSkusResponse extends \Google\Protobuf\Internal\Message
{
    /**
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\Channel\V1\PurchasableSku::class);
        $this->purchasable_skus = $arr;

...
namespace Google\Cloud\SecurityCenter\V1p1beta1\ListAssetsResponse\ListAssetsResult;
 ...
 * will be: UNUSED
 *
 * Protobuf type <code>google.cloud.securitycenter.v1p1beta1.ListAssetsResponse.ListAssetsResult.StateChange</code>
 */
class StateChange
{
    /**
...
class_alias(StateChange::class, \Google\Cloud\SecurityCenter\V1p1beta1\ListAssetsResponse_ListAssetsResult_StateChange::class);

 ...
 *
 * Generated from protobuf message <code>google.cloud.securitycenter.v1p1beta1.ListSourcesResponse</code>
 */
class ListSourcesResponse extends \Google\Protobuf\Internal\Message
{
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Cloud\SecurityCenter\V1p1beta1\Source::class);
        $this->sources = $arr;

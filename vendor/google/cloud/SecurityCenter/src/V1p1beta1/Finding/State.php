 ...
 *
 * Protobuf type <code>google.cloud.securitycenter.v1p1beta1.Finding.State</code>
 */
class State
{
    /**
...
class_alias(State::class, \Google\Cloud\SecurityCenter\V1p1beta1\Finding_State::class);

...
class Registration extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1beta1.Registration.State state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    private $state = 0;
    /**
     ...
     *           update these with the `UpdateRegistration` method. To update these
     *           settings, use the `ConfigureContactSettings` method.
     *     @type \Google\Cloud\Domains\V1beta1\ContactSettings $pending_contact_settings
     *           Output only. Pending contact settings for the `Registration`. Updates to the
     *           `contact_settings` field that change its `registrant_contact` or `privacy`
     *           fields require email confirmation by the `registrant_contact`
     *           before taking effect. This field is set only if there are pending updates
    ...
    {
        GPBUtil::checkEnum($var, \Google\Cloud\Domains\V1beta1\Registration\State::class);
        $this->state = $var;
    ...
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::ENUM, \Google\Cloud\Domains\V1beta1\Registration\Issue::class);
        $this->issues = $arr;

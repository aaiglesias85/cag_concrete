 ...
 *
 * Generated from protobuf message <code>google.cloud.domains.v1alpha2.RetrieveRegisterParametersResponse</code>
 */
class RetrieveRegisterParametersResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.RegisterParameters register_parameters = 1;</code>
     */
     ...
     *
     *     @type \Google\Cloud\Domains\V1alpha2\RegisterParameters $register_parameters
     *           Parameters to use when calling the `RegisterDomain` method.
     * }
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.RegisterParameters register_parameters = 1;</code>
     * @return \Google\Cloud\Domains\V1alpha2\RegisterParameters|null
     */
     ...
     *
     * Generated from protobuf field <code>.google.cloud.domains.v1alpha2.RegisterParameters register_parameters = 1;</code>
     * @param \Google\Cloud\Domains\V1alpha2\RegisterParameters $var
     * @return $this
     */
    public function setRegisterParameters($var)
    {
        GPBUtil::checkMessage($var, \Google\Cloud\Domains\V1alpha2\RegisterParameters::class);

   ...
   public function listar(Request $request)
   {
      try {
         ...
         $dt = DataTablesHelper::parse(
            $request,
            allowedOrderFields: ['id', 'socialSecurityNumber', 'name', 'address', 'phone', 'gender', 'race', 'hourlyRate', 'position'],

...
#[ORM\Table(name: 'invoice_item_override_payment_paid_qty_history')]
#[ORM\Entity(repositoryClass: 'App\Repository\InvoiceItemOverridePaymentPaidQtyHistoryRepository')]
class InvoiceItemOverridePaymentPaidQtyHistory
{
    #[ORM\Id]

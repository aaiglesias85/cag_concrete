...
#[ORM\Entity(repositoryClass: 'App\Repository\InvoiceItemOverrideUnpaidQtyRepository')]
#[ORM\Table(name: 'invoice_item_override_unpaid_qty')]
class InvoiceItemOverrideUnpaidQty
{
   #[ORM\Id]
   #[ORM\GeneratedValue]

...
class AdvertisementService extends Base
{
    ...
    {
        $resultado = $this->getDoctrine()->getRepository(Advertisement::class)
            ->ListarAdvertisementsConTotal($start, $limit, $sSearch, $iSortCol_0, $sSortDir_0, $fecha_inicial, $fecha_fin);

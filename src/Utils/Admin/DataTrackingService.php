...
class DataTrackingService extends Base
{
    ...
    public function SalvarItemDataTracking(
        ...
        if (is_numeric($data_tracking_id)) {
            ...
            if ('' === $project_id || null === $project_id || '' === $date || null === $date) {
        ...
        if (is_numeric($data_tracking_item_id)) {
            ...
            if (null === $data_tracking_item_entity) {
        ...
        if (null !== $data_tracking_item_entity && null !== $data_tracking_item_entity->getProjectItem()) {
        ...
        $isNewLine = null === $data_tracking_item_entity;
        if ($isNewLine) {
        ...
        $notesStr = null !== $notes && '' !== $notes ? (string) $notes : '';
        ...
        if (null !== $oldProjectItemId && $oldProjectItemId !== (int) $item_id) {
    ...
    public function CargarDatosDataTracking($data_tracking_id, $projectService)
    {
        ...
        if (null != $entity) {
            ...
            $arreglo_resultado['project_vendor_id'] = null != $entity->getProject()->getConcreteVendor() ? $entity->getProject()->getConcreteVendor()->getVendorId() : '';
            $arreglo_resultado['project_concrete_vendor'] = null != $entity->getProject()->getConcreteVendor() ? $entity->getProject()->getConcreteVendor()->getName() : '';
            ...
            $arreglo_resultado['overhead_price_id'] = null != $entity->getOverhead() ? $entity->getOverhead()->getOverheadId() : '';
    ...
    public function ListarMaterialsDeDataTracking($data_tracking_id)
    {
        ...
        foreach ($lista as $key => $value) {
            ...
            $items[] = [
                ...
                'unit' => null != $value->getMaterial()->getUnit() ? $value->getMaterial()->getUnit()->getDescription() : '',
                'quantity' => $quantity,
                'price' => $price,
                'total' => $total,
                'posicion' => $key,
    ...
    public function ListarLaborDeDataTracking($data_tracking_id)
    {
        ...
        foreach ($lista as $key => $value) {
            $employee_id = null !== $value->getEmployee() ? $value->getEmployee()->getEmployeeId() : '';

            $subcontractor_employee_id = null !== $value->getEmployeeSubcontractor() ? $value->getEmployeeSubcontractor()->getEmployeeId() : '';
            $subcontractor_id = null !== $value->getEmployeeSubcontractor() ? $value->getEmployeeSubcontractor()->getSubcontractor()->getSubcontractorId() : '';
            $subcontractor = null !== $value->getEmployeeSubcontractor() ? $value->getEmployeeSubcontractor()->getSubcontractor()->getName() : '';
    ...
    public function ListarItemsDeDataTracking($data_tracking_id)
    {
        ...
        foreach ($lista as $key => $value) {
            ...
            $items[] = [
                ...
                'yield_calculation_valor' => 0 == $yield_calculation_valor ? '' : $yield_calculation_valor,
                'equation_id' => null != $value->getProjectItem()->getEquation() ? $value->getProjectItem()->getEquation()->getEquationId() : '',
    ...
    public function SalvarConcVendors($entity, $conc_vendors)
    {
        ...
        foreach ($conc_vendors as $value) {
            ...
            if (null == $data_tracking_conc_vendor_entity) {
    ...
    public function SalvarMaterials($entity, $materials)
    {
        ...
        foreach ($materials as $value) {
            ...
            if (null == $data_tracking_material_entity) {
    ...
    public function SalvarLabor($entity, $labor)
    {
        ...
        foreach ($labor as $value) {
            ...
            if (null == $data_tracking_labor_entity) {
    ...
    public function ValidarSiExisteDataTracking($data_tracking_id, $project_id, $date)
    {
        ...
        if ('' == $data_tracking_id && !empty($data_trackings)) {
            $existe = true;
        } elseif (!empty($data_trackings) && $data_trackings[0]->getId() != $data_tracking_id) {
            $existe = true;
        }

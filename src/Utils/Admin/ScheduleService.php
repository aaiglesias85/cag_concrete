...
class ScheduleService extends Base
{
    ...
    public function ExportarExcel($search, $project_id, $vendor_id, $fecha_inicial, $fecha_fin)
    {
        ...
        $spreadsheet = $reader->load($this->getParameter('kernel.project_dir').DIRECTORY_SEPARATOR.'public'.DIRECTORY_SEPARATOR.'assets'.DIRECTORY_SEPARATOR.'metronic8'.DIRECTORY_SEPARATOR.'excel'.DIRECTORY_SEPARATOR.'schedule.xlsx');
        ...
        foreach ($porFecha as $fecha => $items) {
            ...
            foreach ($items as $value) {
                ...
                $arreglo_resultado[] = [
                    ...
                    'hour' => null != $value->getHour() ? $value->getHour() : '',
    ...
    public function CargarDatosSchedule($schedule_id)
    {
        ...
        if (null != $entity) {
            ...
            $arreglo_resultado['project_contact_id'] = null != $entity->getContactProject() ? $entity->getContactProject()->getContactId() : '';
            ...
            $arreglo_resultado['hour'] = null != $entity->getHour() ? $entity->getHour() : '';
            ...
            $vendor_id = null != $entity->getConcreteVendor() ? $entity->getConcreteVendor()->getVendorId() : '';

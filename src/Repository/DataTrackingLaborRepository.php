...
class DataTrackingLaborRepository extends EntityRepository
{
     ...
     *
     */
    public function ListarReporteEmployeesConTotal(int $start, int $limit, ?string $sSearch = null, string $sortField = 'date',
                                                        string $sortDir = 'DESC', ?string $employee_id = null, ?string $project_id = null, ?string $fecha_inicial = null, ?string $fecha_fin = null): array {

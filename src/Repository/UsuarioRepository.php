...
class UsuarioRepository extends ServiceEntityRepository
{
    ...
    public function ListarUsuarios(
        ...
        // Ordenación
        $qb->orderBy('perfil' === $iSortCol_0 ? 'r.nombre' : "u.$iSortCol_0", $sSortDir_0);
     ...
     * @return Usuario[]
     */
    public function ListarUsuariosRoles(array $roles): array
    {
        return $this->createQueryBuilder('u')
           ->leftJoin('u.rol', 'r')
           ->where('r.rolId IN (:roles)')
     ...
     */
    public function ListarUsuariosConTotal(
        int $start,
        int $limit,
        ?string $sSearch = null,
